        ...
        <main className="space-y-10 py-12 md:py-16">
          ...
          <section className="space-y-6">
            ...
            <div className="grid gap-5 md:grid-cols-2">
              {postpartumSupportAreas.map((area) => (
          ...
          <SectionCard>
            <div className="max-w-3xl space-y-4">
              ...
              <p className="leading-7 text-muted-foreground">
                Families may experience many adjustments after birth. Postpartum
                doulas may provide reassurance, practical presence, and general
                information while health-related questions remain with qualified
                providers or appropriate supports.
              </p>
          ...
          <SectionCard>
            <div className="max-w-3xl space-y-4">
              ...
              <p className="leading-7 text-muted-foreground">
                Families may have many questions after birth. Postpartum doulas
                may help families organize questions and feel supported while
                they communicate with qualified providers or appropriate
                specialists.
              </p>
              <p className="leading-7 text-muted-foreground">
                Health-related or individualized concerns belong with qualified
                providers or appropriate specialists.
              </p>
            </div>
          </SectionCard>
