        ...
        <main className="space-y-10 py-12 md:py-16">
            ...
            <div className="grid gap-8 p-7 md:grid-cols-[1.5fr_0.8fr] md:p-10">
              <div className="space-y-5">
                ...
                <p className="max-w-3xl text-lg leading-8 text-muted-foreground">
                  ...
                  family-centred support for families and support people
                  navigating loss.
                </p>
              </div>
              <aside className="rounded-[1.5rem] border border-border bg-background/70 p-5">
                <p className="text-sm font-semibold uppercase tracking-[0.18em] text-primary">
                  Sensitive support page
                </p>
                <p className="mt-3 leading-7 text-muted-foreground">
                  This page uses gentle, non-clinical language and does not
                  replace qualified medical, mental-health, crisis, legal,
                  funeral, or spiritual supports.
                </p>
              </aside>
            </div>
          </section>
          ...
          <section className="space-y-6">
            ...
            <div className="grid gap-5 md:grid-cols-2">
              {lossSupportAreas.map((area, index) => (
          ...
          <div className="grid gap-5 lg:grid-cols-2">
            <SectionCard>
              <div className="space-y-4">
                ...
                <p className="leading-7 text-muted-foreground">
                  Pregnancy and infant loss support may happen at different
                  points. Doulas may offer steady presence, practical support,
                  and general organization while qualified providers and
                  appropriate supports remain responsible for regulated concerns.
                </p>
            ...
            <SectionCard>
              <div className="space-y-4">
                ...
                <p className="leading-7 text-muted-foreground">
                  ...
                  or individualized recommendation.
                </p>
                <ul className="list-disc space-y-3 pl-6 leading-7 text-muted-foreground">
          ...
          <section className="space-y-6">
            <div className="max-w-3xl space-y-3">
              ...
              <p className="leading-7 text-muted-foreground">
                ...
                household members, or chosen support people. This page uses
                broad family-support language only and does not provide grief
            ...
            <SectionCard>
              <div className="space-y-4">
                ...
                <p className="leading-7 text-muted-foreground">
                  ...
                  not provide medical advice, counselling, therapy, crisis
                  support, emergency support, bereavement counselling, legal
                  advice, funeral direction, spiritual direction, intake,
